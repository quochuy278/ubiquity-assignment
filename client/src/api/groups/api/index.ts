...
import { GroupsApi, SubtasksApi, TodoListsApi, TodosApi } from '@/api/generated';
...
export const subtasksApi = new SubtasksApi(generatedApiConfiguration, undefined, httpClient);
